        ...
        <div class="footer__mid">
            ...
            <div class="image">
                <a href="he-thong-cua-hang/index.html" title="Hệ thống cửa hàng" class="image cover">
                    <img data-src="" class="lazyload" alt="Dang Quang Watch" src="{{ asset('images/banner/dongho.jpg') }}" />
                </a>
...
<div id="bottom">
    <div class="wrapper">
        <a href="index.html" title="" class="logo">
            <img data-src="" class="lazyload" alt="Dang Quang Watch" src="{{ asset('view/Css/icon/Logo.png') }}" />
        </a>
        <div class="right">
